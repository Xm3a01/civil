            ...
            <div class="row">
              <div class="col-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control w-100" name="message" id="message" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'الرســــــــــــاله'" placeholder = 'الرســــــــــــاله'></textarea>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
              ...
              <div class="col-12">
                <div class="form-group">
                  <input class="form-control" name="subject" id="subject" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'الموضوع'" placeholder = 'الموضوع'>
                </div>
              </div>
            </div>
