...
<div class="row">
    <div class="col-sm-12">
        <div class="white-box">
            ...
            <form class="form-material form-horizontal" method="POST" action="{{ route('abouts.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label class="col-md-12" for="profile">Profile</label>
                    <div class="col-md-12">
                        <textarea class="form-control" id="mymce" name="profile" rows="4"></textarea>
                    </div>
                </div>
                <div class="form-group" style="text-align:right;">
                    <label class="col-md-12" for="ar_profile">نبــــذه</label>
                    <div class="col-md-12">
                        <textarea class="form-control" id="mymce" name="ar_profile"></textarea>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group" style="text-align:right;">
                        ...
                        <div class="col-md-12">
                            <input class="form-control" style="text-align:right" type="text" name="ar_address" id="" placeholder="العنوان">
                        </div>
                    </div>
                    <div class="form-group">
                    <label for="phone" class="col-md-12">Phone</label>
                    <div class="col-md-12">
                        <input class="form-control" type="text" name="phone" id="" placeholder="Tel-Phone">
                    </div>
                </div>
                <div class="form-group">
